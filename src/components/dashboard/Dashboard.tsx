...
import { Trophy, Target, Calendar, Award, Plus, Flame, Route } from 'lucide-react';
import { DashboardData } from '../../utils/interfaces';
...
export function Dashboard() {
  ...
  const [habits, setHabits] = useState<DashboardData>(dummyHabitData)
  const [loader, setLoader] = useState<DashboardData>(false)
  ...
  return (
    <div className="min-h-screen bg-background p-4 space-y-6">
      ...
      {
        loader ? (
          <ApiLoader message="Loading dashboard..." fullScreen={true} showLoader={true} />
        ) : (
          <>
            {/* Quick Stats */}
